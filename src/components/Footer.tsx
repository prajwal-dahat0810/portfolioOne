...
export const Footer = () => {
  ...
  return (
    <footer className=" bg-white rounded-lg shadow dark:bg-gray-900 m-4">
      <div className="flex gap-col not-sr-only max-sm:sr-only">
        <div className=" flex gap-9 ">
          <div className="pb-4 pt-5">
            <div className="absolute left-36  inline-block">
              ...
              >
                <Link to={"mailto:dahatprajwal11@gmail.com"}>
      ...
      <div className=" sr-only justify-center items-center gap-4 flex-row flex pt-9   max-sm:not-sr-only">
        <Link to={"mailto:dahatprajwal11@gmail.com"}>
          <div className="flex  left-2 top-6  border  items-center w-9 h-9 text-white justify-center cursor-pointer rounded-full bg-teal-400 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <Link to={"https://github.com/prajwal-dahat0810"}>
          <div className="flex left-24 top-7  border  items-center w-9 h-9 text-white justify-center cursor-pointer rounded-full bg-teal-400">
        ...
        <Link
          ...
          target="_blank"
        >
          <div className="flex row relative left-0   border  items-center w-9 h-9 text-white justify-center cursor-pointer rounded-full bg-teal-400">
      ...
      <div className="w-full   mx-auto p-2 md:py-3">
        <hr className="my-1 w-full border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-2" />
